...
import com.eduardoomarson.quizpdm.ui.feature.history.HistoryScreen  //adicionado por José Vitor
...
fun QuizAppNavHost() {
    ...
    NavHost(navController = navController, startDestination = startDestination) {
        ...
        composable<HistoryRoute> {  //Editado por José Vitor
            HistoryScreen(
                onBackClick = { navController.popBackStack() },
                onHomeClick = { navController.navigate(HomeRoute) },
                onBoardClick = { navController.navigate(BoardRoute) },
        ...
        composable<HomeRoute> {
            HomeScreen(
                ...
                onHistoryClick = {  // Editado por José Vitor
